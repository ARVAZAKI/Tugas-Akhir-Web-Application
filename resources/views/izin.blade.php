    ...
    <div class="container">
        <div class="flex items-center justify-center h-screen">
            <div class="min-w-full px-4 py-3 space-y-8 border-2 rounded-lg shadow-lg">
                ...
                <form action="{{ route('izinPost') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="block text-[#0d3676] mb-2">Upload Surat Izin</label>
                            <div class="flex justify-center">
                                <input type="file" name="surat_izin" class="block w-full text-sm text-slate-500
                        ...
                        {{-- Input Tanggal Izin --}}
                        <div>
                            <label class="block text-[#0d3676] mb-2">Tanggal Izin</label>
                            <div class="flex justify-center">
                                <input type="date" name="tanggal_izin" class="w-full py-2 bg-slate-100 border border-gray-300 rounded-md" required>
                            </div>
                        </div>
