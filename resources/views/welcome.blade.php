        ...
        <div class="min-h-screen flex flex-col lg:flex-row">
            <div class="w-full lg:w-1/2 flex justify-center items-center p-4 lg:p-8">
                <div class="w-full max-w-md">                
                    ...
                    <div class="space-y-4">
                        <a href="{{route('login')}}" class="w-full bg-[#0B235E] text-white py-4 px-6 rounded-lg flex justify-between items-center hover:bg-blue-800 transition-colors no-underline">
                            <div>
                        ...
                        <a href="{{route('login')}}" class="w-full bg-gray-100 text-[#0B235E] py-4 px-6 rounded-lg flex justify-between items-center hover:bg-gray-200 transition-colors no-underline">
                            <div>
